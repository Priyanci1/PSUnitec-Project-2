                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-7">
                            ...
                            <div class="booking-form">
                                ...
                                <div class="data-form">
                              <form class="form-horizontal mb-0" action="reply.php">
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="form-surname" id="form-surname" placeholder="YOUR AGE">
                                            </div>
                                            <div class="col-md-6">
                                                <input type="text" name="form-surname" id="form-surname" placeholder="SEX">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <input type="text" name="form-address2" id="form-address2" placeholder="LOCATION">
                                            </div>
                                           
                                            <div class="col-md-6">
                                                <input type="text" name="form-address2" id="form-address2" placeholder="NATIONALITY">
                                            </div>
                                                ...
                                                <div class="form-group text-center row m-t-20">
                                                    <div class="col-12">
                                                        <button style="background-color:;" class="btn btn-raised btn-primary btn-block waves-effect waves-light" type="submit">submit</button>
                                                    </div>
                                                </div>
