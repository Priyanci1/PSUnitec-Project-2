    ...
    <div class="section">
        <div class="widget-page-title">
            ...
            <div class="wrapper-inner">
                ...
                <h5>About Page</h5>
                <h1>Description</h1>
                <p>This is the website where peoples dream comes to a reality, where you can book your holiday stays or honeymoon stays or your meetings from our large collection of hotels and their different types of rooms. Also, Here you can get the virtual reality in 360 panaromic view of the rooms of the hotel. If you are facing any problems with the page as well as with the hotels then also you can submit your wuery to our contact us page. We also welcome great suggestions and offers. Go Online Get Booked</p>
                <!-- Title End -->
                <!-- Breadcrumb -->
